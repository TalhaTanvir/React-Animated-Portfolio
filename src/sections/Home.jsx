      ...
      <div className='relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2'>
        <div className='flex flex-col justify-center h-full text-center lg:text-left relative'>
          <div className='w-full lg:pr-24 mx-auto max-w-[48rem]'>
            ...
            <motion.p className='mt-6 text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto lg:mx-auto'
            ...
            >
              ...
              <a href="/Talha Tanvir CV.pdf" download className='px-6 py-3 rounded-full font-medium text-lg bg-white text-black hover:bg-gray-200 shadow-lg hover:scale-105 transition-all'>My Resume</a>
            </motion.div>

            <div className='mt-10 flex gap-5 text-2xl md:text-3xl justify-center lg:justify-start'>
              {
                socials.map(({Icon, label, href})=>(
                  <motion.a href={href} key={label} target='_blank' aria-label={label} rel='noopener noreferrer' variants={glowVarients} initial='initial' whileHover="hover" whileTap="tap" className='text-gray-300'>
                    <Icon/>
        ...
        <div className='relative hidden lg:block'>
          ...
          <motion.img src={avator} alt="Main Home Image" 
